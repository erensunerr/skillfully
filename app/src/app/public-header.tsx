...
export function PublicHeader({
  ...
  const bookingClass = isDark
    ...
    : "inline-flex items-center justify-center rounded-md border border-[var(--ink)] bg-[var(--ink)] px-3 py-2 font-editorial-sans text-xs font-semibold text-[var(--paper)] transition hover:bg-[var(--paper)] hover:text-[var(--ink)] sm:px-4 sm:text-sm";

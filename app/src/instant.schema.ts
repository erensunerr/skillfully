...
const _schema = i.schema({
  entities: {
    ...
    skillVersions: i.entity({
      ...
      versionNumber: i.number().indexed().optional(),
      status: i.string().indexed(),
    ...
    publishingTargets: i.entity({
      ...
      repositoryId: i.string().indexed().optional(),
    ...
    githubInstallations: i.entity({
      ...
      accountId: i.string().indexed().optional(),
    ...
    skillImports: i.entity({
      ...
      repoFullName: i.string().indexed().optional(),
      status: i.string().indexed(),
      sessionId: i.string().unique().indexed().optional(),
      installationId: i.string().indexed().optional(),
      accountLogin: i.string().indexed().optional(),
      accountType: i.string().indexed().optional(),

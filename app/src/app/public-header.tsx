...
export function PublicHeader({ showBookingCta = true }: { showBookingCta?: boolean } = {}) {
  ...
  return (
    <header className="grid min-h-16 grid-cols-[1fr_auto] items-center gap-4 border-b border-[var(--ink)] bg-[var(--ink)] px-5 py-3 text-[var(--paper)] sm:grid-cols-[1fr_auto_1fr] lg:px-8">
      <Link
        href="/"
      ...
      <div className="justify-self-end flex items-center justify-end gap-2 sm:gap-3">
        <LandingAuthLink
          ...
          intent="sign_in"
          surface="header"
          className="inline-flex items-center justify-center rounded-md border border-[var(--paper)] bg-transparent px-3 py-2 font-editorial-sans text-xs font-semibold text-[var(--paper)] transition hover:bg-[var(--paper)] hover:text-[var(--ink)] sm:px-4 sm:text-sm"
        >
          Log in
        </LandingAuthLink>
        {showBookingCta ? (
          <BookingModalCta
            surface="header"
            className="inline-flex items-center justify-center rounded-md border border-[var(--paper)] bg-[var(--paper)] px-3 py-2 font-editorial-sans text-xs font-semibold text-[var(--ink)] transition hover:bg-transparent hover:text-[var(--paper)] sm:px-4 sm:text-sm"
          >
